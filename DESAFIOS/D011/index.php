  ...
  <?php
    ...
    <h2>Resultado do Reajuste</h2>
        <?php
            ...
            echo "O Produto que custava <strong> R$ " . number_format($valor, 2, ',', '.') . "</strong>, com um aumento de <strong>" . $porcentagem . "%  de aumento </strong>, vai passar a custar R$ " . number_format($novo_valor, 2, ',', '.') . ".";
